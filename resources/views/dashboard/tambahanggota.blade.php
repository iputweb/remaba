		...
		<div class="brosur rounded-5 container mt-5 p-3">
				<div class="row">
						<div class="col-md-6 col-12">
								<h2 class="fw-bold fs-2 text-danger mt-5">Tambah Anggota</h2>
								<h6 class="subtitle fs-5 text-dark">Tambahkan anggota baru</h6>
						</div>
				</div>
		</div>
								...
								<div class="col-md-6 col-12">
										<p>
												...
												@if (session('msg'))
														{{ session('msg') }}
												@endif
										<form action="{{ url('/anggota/simpan') }}" method="POST" enctype="multipart/form-data">
												@csrf
												<table style="widows: 70%;">
														...
														<tr>
																<td class="text-dark">No WA :</td>
																<td>
																		<input class="form-control border-radius-5 border-secondary mt-3 p-1" type="text" name="no" placeholder="Pake 62"
																				id="no">
																</td>
														</tr>
                                                        <tr>
																...
																<td>
																		<input class="form-control border-radius-5 border-secondary mt-3 p-1" type="text" name="jabatan"
																				id="jabatan">
																</td>
														</tr>
														<tr>
